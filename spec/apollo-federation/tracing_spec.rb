...
RSpec.describe ApolloFederation::Tracing do
  shared_examples 'records correct metrics' do
                ...
                },
                {
                  ...
                  child: [{
                    ...
                    error: [{
                      ...
                      json: %({"message":"Can't continue with this query",\
"locations":[{"line":1,"column":15}],"path":["items",1,"name"]}),
  ...
  context 'when using the legacy runtime' do
    let(:base_schema) do
    ...
    include_examples 'records correct metrics'
  end

  context 'when using the interpreter runtime' do
    let(:base_schema) do
      Class.new(GraphQL::Schema) do
        use ApolloFederation::Tracing
